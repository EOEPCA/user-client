"""Logging utilities for eoepca_client using loguru."""
...
def setup_logging(
    ...
    """Set up logging for the eoepca_client package using loguru.
...
def get_logger(name: str | None = None) -> Logger:
    """Get a logger instance for the eoepca_client package.
    ...
    if name:
        ...
        return logger.bind(module="eoepca_client")
